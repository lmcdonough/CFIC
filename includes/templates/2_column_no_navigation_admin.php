				...
				<div class="container">
					...
					<div class="row">
						<div id='left_column' class="col-md-6">
							<div class='row'>
							<h3 class='pull-left col-lg-6'>Left Column</h3>	
									...
									<div class="padd">
										...
										<form class="form-horizontal" role="form">
											<div class="form-group">
												...
												<div style="margin-left:0px; margin-top:15px;" id="' . $top_nav_id . '" data-column="item_heading" data-table="main_menu_items"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>	
												</div>
												<div class="col-lg-12 row">
													...
													<div style="margin-left:0px; margin-top:15px;" id="' . $top_nav_id . '" data-column="item_content" data-table="main_menu_items" class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>												
												</div>
												<div class="row col-lg-12">
						...
						<div id='right_column' class="col-md-6">
							<div class='row'>
							<h3 class='pull-left col-lg-6'>Right Column</h3>	
							<div class='pull-right btn btn-success add_new_row_right col-lg-2' style='margin-right:20px;' data-table='right_menu_items'>Add Row</div>
								...
								<?php									
									...
									$top_nav_page_id = $top_nav_item['page_id'];	
									$top_nav_item_heading = $top_nav_item['item_heading'];
									$top_nav_right_heading = $top_nav_item['right_menu_heading'];
									$top_nav_item_content = $top_nav_item['item_content'];									
									...
									<div class="padd">
										...
										<form class="form-horizontal" role="form">
											<div class="form-group">
												...
												<input name="Main_heading" class="col-lg-8 pull-left" type="text" value="' . $top_nav_right_heading . '"></input>
												<div style="margin-left:0px; margin-top:0px; padding-left:0px; padding-right:0px;" id="' . $top_nav_id . '" data-column="right_menu_heading" data-table="content"  class="col-lg-1 edit_main save_changes_main btn btn-success pull-right">Save</div>	
												</div></br>
											</div>											
										</form>											
									</div>
									...
									<div class="padd">
										...
										<form class="form-horizontal" role="form">
											<div class="form-group">
												...
												<label class="col-lg-2 control-label">Header</label>
												<input name="Main_heading" class="col-lg-7" type="text" value="' . $top_nav_item_heading . '"></input>
												<div style="margin-left:0px; margin-top:15px;" id="' . $top_nav_id . '" data-column="item_heading" data-table="right_menu_items"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>	
												</div>
												<div class="col-lg-12 row">
													<label class="col-lg-1 control-label">Body</label>
													<div id="testing" class="col-lg-9" style="margin-right:0px;">													
													...
													<div style="margin-left:0px; margin-top:15px;" id="' . $top_nav_id . '" data-column="item_content" data-table="right_menu_items" class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>												
												</div>
												<div class="row col-lg-12">
