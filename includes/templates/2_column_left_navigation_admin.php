				...
				<div class="container">
					...
					<div class="row">
						<div id='left_column' class="col-md-6">
							<div class='row'>
							<h3 class='pull-left col-lg-6'>Left Menu</h3>								
							<div class='pull-right btn btn-success add_new_row_left col-lg-2' style='margin-right:20px;' data-column='.left_append' data-table='template_2_left_menu_items'>Add Row</div>
							</div>
								<?php									
									$row = $_GET["num"];
									$i=1;
									$top_nav = mysql_query("SELECT * FROM template_2_left_menu_items WHERE page_id='$row'");
										...
										<form class="form-horizontal" role="form">
											<div class="form-group">
												<div class="row col-lg-12">
													...
													<input name="Main_heading" class="col-lg-7" type="text" value="' . $top_nav_menu_item . '"></input>
													<div style="margin-left:0px; margin-top:0px;" id="' . $top_nav_id . '" data-column="menu_item" data-table="template_2_left_menu_items"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>	
												</div></br>
												<div class="row col-lg-12">
													<label class="col-lg-2 control-label">Link</label>
													<input name="Main_heading" class="col-lg-7" type="text" value="' . $top_nav_link . '"></input>
													<div style="margin-left:0px; margin-top:0px;" id="' . $top_nav_id . '" data-column="link" data-table="template_2_left_menu_items"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>	
												</div></br>
												<div class="row col-lg-12">
												<div id="' . $top_nav_id . '" data-table="template_2_left_menu_items" class="edit_main remove_main btn btn-danger pull-right">Remove Row</div>
												</div>
											</div>											
										</form>											
									</div>
						...
						<div id='right_column' class="col-md-6">
							...
							<h3 class='pull-left col-lg-6'>Main Heading</h3>							
								...
								<?php									
									...
									While($top_nav_item = mysql_fetch_array($top_nav)){		
									$top_nav_id = $top_nav_item['id'];						
									$top_nav_main_menu_heading = $top_nav_item['main_menu_heading'];									
									...
									<div class="padd">
										...
										<form class="form-horizontal" role="form">
											<div class="form-group">
												...
												<input name="Main_heading" class="col-lg-7" type="text" value="' . $top_nav_main_menu_heading . '"></input>
												<div style="margin-left:0px; margin-top:0px;" id="' . $top_nav_id . '" data-column="main_menu_heading" data-table="content"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>	
												</div>
											</div>											
										</form>											
									</div>
							...
							<div class='pull-right btn btn-success add_new_row_right col-lg-2' style='margin-right:20px;' data-table='main_menu_items'>Add Row</div>
							</div>
								<?php									
									$row = $_GET["num"];
									$top_nav = mysql_query("SELECT * FROM main_menu_items WHERE page_id='$row'");
									While($top_nav_item = mysql_fetch_array($top_nav)){		
									$top_nav_id = $top_nav_item['id'];						
									$top_nav_page_id = $top_nav_item['page_id'];	
									...
									<div class="padd">
										...
										<form class="form-horizontal" role="form">
											<div class="form-group">
												...
												<div style="margin-left:0px; margin-top:0px;" id="' . $top_nav_id . '" data-column="item_heading" data-table="main_menu_items"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>	
												</div>
												<div class="col-lg-12 row">
													<label class="col-lg-1 control-label">Body</label>
													<div id="testing" class="col-lg-9" style="margin-right:0px;">													
														<textarea id="cleditor" class="cleditor content_value" name="input">' . $top_nav_item_content . '</textarea>													
													</div>
													<div style="margin-left:0px; margin-top:15px;" id="' . $top_nav_id . '" data-column="item_content" data-table="main_menu_items" class="editor_field col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div>												
												</div>
												<div class="row col-lg-12">
												<div id="' . $top_nav_id . '" data-table="main_menu_items" class="edit_main remove_main btn btn-danger pull-right">Remove Row</div>
												</div>
											</div>											
										</form>											
									</div>
		...
		//need to also execute insert query to add row in database first here
			...
			$.ajax({
				...
				function(response){	
					...
					var html = 	'<div class="widget col-md-12"><div class="widget-content"><div class="padd"><form class="form-horizontal" role="form"><div class="form-group"><div class="row col-lg-12"><label class="col-lg-2 control-label">Label</label><input name="Main_heading" class="col-lg-7" type="text" value=""></input><div style="margin-left:0px; margin-top:0px;" id="'+last_id+'" data-column="menu_item" data-table="'+table+'"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div></div></br><div class="row col-lg-12"><label class="col-lg-2 control-label">Link</label><input name="Main_heading" class="col-lg-7" type="text" value=""></input><div style="margin-left:0px; margin-top:0px;" id="'+last_id+'" data-column="link" data-table="'+table+'"  class="col-lg-2 edit_main save_changes_main btn btn-success pull-right">Save</div></div></br><div class="row col-lg-12"><div id="'+last_id+'" data-table="template_2_left_menu_items" class="edit_main remove_main btn btn-danger pull-right">Remove Row</div></div></div></form></div></div></div>';
